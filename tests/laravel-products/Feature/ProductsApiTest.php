...
class ProductsApiTest extends TestCase
{
    ...
    public function test_attempt_to_create_root_product_with_bad_name_field()
    {
        $array = [
            'payload' => [
                ['name' => 123],
    ...
    public function test_attempt_to_create_root_product_with_bad_slug_field()
    {
        $array = [
            'payload' => [
                ['slug' => ''],
    ...
    public function test_attempt_to_create_root_product_with_bad_enabled_field()
    {
        $array = [
            'payload' => [
                ['enabled' => ''],
    ...
    public function test_attempt_to_create_root_product_ok()
    {
        $payload['name'] = 'test-name';
        $payload['slug'] = 'test-slug';
        $payload['description'] = 'Test description';
    ...
    public function test_attempt_to_create_root_and_child_product_ok()
    {
        $payload['name'] = 'test-name';
        $payload['slug'] = 'test-slug';
        $payload['description'] = 'Test description';
    ...
    public function test_attempt_to_update_root_product_with_errors()
    {
        $payload['name'] = 'test-name';
        $payload['slug'] = 'test-slug';
        $payload['description'] = 'Test description';
